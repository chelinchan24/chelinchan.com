...
$(window).load(function() {
    ...
    var toDate = moment("2027-06-01");

    var yearsUntil = toDate.diff(todaysDate, 'years');
    var monthsUntil = toDate.diff(todaysDate, 'months') % 12;

    $('#倒數-年').text(yearsUntil);
    $('#倒數-月').text(monthsUntil);
});
