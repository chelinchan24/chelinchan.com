...
win.onscroll = function(){
   ...
   document.getElementById('專輯資訊盒子').className =  sTop > 278 ? "浮動-專輯資訊盒子" : "none" ;
   document.getElementById('專輯封面').className =  sTop > 278 ? "浮動-專輯封面" : "none" ;
   document.getElementById('專輯文字資訊').className =  sTop > 278 ? "浮動-專輯文字資訊" : "none" ;
   document.getElementById('名稱').className =  sTop > 278 ? "浮動-名稱" : "none" ;
   document.getElementById('歌曲數目與可提供數目').className =  sTop > 278 ? "浮動-年份與類型" : "none" ;
   document.getElementById('播放按鈕').className =  sTop > 278 ? "浮動-播放按鈕" : "none" ;
   document.getElementById('可提供數目說明').className =  sTop > 278 ? "浮動-可提供數目說明" : "none" ;
   document.getElementById('年份與類型').className =  sTop > 278 ? "浮動-年份與類型" : "none" ;
